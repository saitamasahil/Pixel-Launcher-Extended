...
if exist "C:\Program Files\7-Zip\7z.exe" (
  ...
  "C:\Tools\7z.exe" a -tzip PixelLauncherExtended.zip * -x!.git\* -x!ThemedIcons\* -x!screenshots\* -x!autobuild.bat -x!banner.jpg -x!banner2.jpg -x!codename.txt -x!logo.png -x!online_installer_setup.sh -x!README.md
) else (
