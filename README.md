...
PLE Builder relies on rc file to store and load its configuration settings & it supports the following shells that have rc files:
- bash
- zsh
- csh
- ksh
...
```
- Once you see the installation success message, Type **PLE** in terminal to launch PLE Builder.
...
chmod +x builder_dependencies.sh && ./builder_dependencies.sh
```
- Once you see the installation success message, Type **PLE** in termux to launch PLE Builder.
...
- To run PLE Builder again, Type **PLE** in termux.
