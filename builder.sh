...
# Building Options - Offline Installer
...
# Building Options - Online Installer
...
init_ple(){
  ...
  if [ $choice -eq 1 ]; then offline_build

  elif [ $choice -eq 2 ]; then online_build
...
# Argument for handling unattended building
...
# Greet the user based on the name
case $name in
  offline)
    offline_build
    ;;
